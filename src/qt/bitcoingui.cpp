...
void BitcoinGUI::updateStakingIcon()
{
    ...
    if (!walletView) {
        ...
        labelStakingIcon->setToolTip(tr("Not mining"));
        return;
    }
    WalletModel * const walletModel = walletView->getWalletModel();
            ...
            walletModel->wallet().getEnabledStaking() && nWeight)
    {
        ...
        labelStakingIcon->setToolTip(tr("CPU mining."));
    }
    else
    {
        labelStakingIcon->setPixmap(platformStyle->SingleColorIcon(":/icons/staking_off").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
        ...
        if (m_node.getNodeCount(CConnman::CONNECTIONS_ALL) < 4)
            ...
            labelStakingIcon->setToolTip(tr("Not mining because you don't have mature transactions"));
        else if (walletModel->wallet().isLocked())
            labelStakingIcon->setToolTip(tr("Not mining because wallet is locked"));
        else
            labelStakingIcon->setToolTip(tr("Not mining"));
    }
}
