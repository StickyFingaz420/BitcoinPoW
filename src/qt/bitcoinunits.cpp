...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(BTCW);
    unitlist.append(mBTCW);
    unitlist.append(uBTCW);
    unitlist.append(SAT);
    return unitlist;
}
...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTCW: return QString("BTCW");
    case mBTCW: return QString("mBTCW");
    case uBTCW: return QString::fromUtf8("µBTCW (bits)");
...
QString BitcoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uBTCW: return QString::fromUtf8("bits");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTCW: return QString("Bitcoins");
    case mBTCW: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTCW: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case BTCW: return 100000000;
    case mBTCW: return 100000;
    case uBTCW: return 100;
    case SAT: return 1;
